    ...
    create: {
      ...
      mentorProfile: {
        create: {
          ...
          expertise: ['NEET UG', 'Medical', 'Interviews', 'Career Planning'],
          yearsExperience: 15,
          hourlyRate: 800,
          rating: 4.9,
          totalSessions: 340
    ...
    create: {
      ...
      mentorProfile: {
        create: {
          ...
          role: 'IAS Officer',
          expertise: ['UPSC CSE', 'Government Exams', 'Strategy', 'Answer Writing'],
          yearsExperience: 3,
          hourlyRate: 0,
          rating: 4.95,
          totalSessions: 125
    ...
    create: {
      ...
      mentorProfile: {
        create: {
          ...
          expertise: ['Engineering', 'JEE Advanced', 'GATE', 'Tech Interviews'],
          yearsExperience: 7,
          hourlyRate: 500,
          rating: 4.8,
          totalSessions: 89
    ...
    create: {
      ...
      mentorProfile: {
        create: {
          ...
          expertise: ['Design', 'NID', 'Portfolio', 'UI/UX'],
          yearsExperience: 8,
          hourlyRate: 400,
          rating: 4.85,
          totalSessions: 156
    ...
    create: {
      ...
      mentorProfile: {
        create: {
          ...
          role: 'Head Coach',
          expertise: ['Sports', 'Scholarships', 'Athletics', 'Training'],
          yearsExperience: 12,
          hourlyRate: 300,
          rating: 4.7,
          totalSessions: 210
    ...
    create: {
      ...
      mentorProfile: {
        create: {
          ...
          expertise: ['Study Abroad', 'Ivy League', 'SAT', 'Essays'],
          yearsExperience: 6,
          hourlyRate: 1000,
          rating: 4.95,
          totalSessions: 420
