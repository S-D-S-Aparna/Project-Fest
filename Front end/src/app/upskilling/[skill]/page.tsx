...
import { Rocket, Calendar, MapPin, Users, ChevronRight, CheckCircle2, Code, Database, Monitor, type LucideIcon } from "lucide-react";
...
interface UpskillingData {
  title: string;
  gradient: string;
  description: string;
  icon: LucideIcon;
  events: UpskillingEvent[];
}

const upskillingData: Record<string, UpskillingData> = {
  "agentic-ai": {
    title: "Agentic AI",
...
export default function UpskillingSkillPage() {
  ...
  const data: UpskillingData = upskillingData[skillSlug] || {
