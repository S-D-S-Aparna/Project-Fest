    ...
    <MainLayout>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8 text-center mb-8">
        ...
        <div className="flex justify-center gap-4">
           <Link href="/mentors" className="bg-blue-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-sm text-sm">
             Talk to a Mentor
           </Link>
           <Link href="/resources" className="bg-white border border-gray-200 text-gray-700 px-6 py-2.5 rounded-lg font-medium hover:bg-gray-50 transition-colors text-sm">
             View Resources
           </Link>
        </div>
      </div>
