...
import { CheckCircle, Calendar, MapPin, GraduationCap, Tag, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="max-w-3xl mx-auto py-12">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mb-6 shadow-lg border-4 border-blue-100">
            ...
            <p className="text-blue-100 text-lg">
              Your spot for the {details.activity} {details.type?.toLowerCase()} is secured.
            </p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  {details.date ? new Date(details.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : ''}
                </p>
              </div>
            </div>
          ...
          <div className="mt-10 pt-6 border-t flex flex-col sm:flex-row gap-4">
            <Link 
              href="/education" 
              className="flex-1 text-center bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition-colors shadow-md"
            >
              Back to Education
            </Link>
            <Link 
...
export default function EducationBookingSuccessPage() {
  return (
    <MainLayout>
