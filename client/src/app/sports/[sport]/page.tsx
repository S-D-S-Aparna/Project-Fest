...
import { Trophy, Calendar, MapPin, Users, ChevronRight, CheckCircle2, Shield, Activity } from "lucide-react";
...
export default function SportPage() {
  ...
  // Fallback to a generic sport if not mapped
  const data = sportData[sportSlug] || {
