...
import { Calendar, Search, Users, MapPin, Clock } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {events.map(event => (
              <div key={event.id} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <a href={event.url || "#"} className="mt-6 block w-full text-center bg-orange-500 hover:bg-orange-600 text-white py-2 rounded-lg font-medium transition-colors text-sm shadow-sm">
                  Register / RSVP
                </a>
              </div>
            ))}
